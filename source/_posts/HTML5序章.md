...
password: 31278792
---
**一天天宅着蛮枯燥的，HTML5地学习或许能打破这乏味的时光。以前刚开始学习 HTML ，才明白前端是如何实现的，当然也少不了CSS、JavaScript。像我们这博客完全是通过这3样语言实现的静态网页，瞬间感觉前端是不是比后端更看得出成果，你光使用后端语言是无法完成Web网页开发。话不多说，言归正传，开始我们今天HTML5的学习！**
## HTML5概述
